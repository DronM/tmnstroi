...
function Store_Controller(options){
	options = options || {};
	options.listModelClass = StoreList_Model;
	options.objModelClass = StoreList_Model;
	Store_Controller.superclass.constructor.call(this,options);	
...
extend(Store_Controller,ControllerObjServer);
