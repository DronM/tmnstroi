 ...
 */
function DocPassToProductionList_View(id,options){	

	options.HEAD_TITLE = "Передача материалов в производство";

	DocPassToProductionList_View.superclass.constructor.call(this,id,options);
	
	var model = options.models.DocPassToProductionList_Model;
	var contr = new DocPassToProduction_Controller();
	...
	this.addElement(new GridAjx(id+":grid",{
		...
		"controller":contr,
		"editInline":false,
		"editWinClass":DocPassToProductionDialog_Form,
