...
function DocPassToProductionDialog_Model(options){
	var id = 'DocPassToProductionDialog_Model';
	options = options || {};
	...
	options.fields.materials = new FieldJSON("materials",filed_options);
		...
		DocPassToProductionDialog_Model.superclass.constructor.call(this,id,options);
}
