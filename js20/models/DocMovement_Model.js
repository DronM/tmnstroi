...
function DocMovement_Model(options){
	...
	options.fields.oktmo_contract_id.getValidator().setRequired(true);
	...
	options.fields.to_oktmo_contract_id.getValidator().setRequired(true);
	...
	options.fields.materials = new FieldJSONB("materials",filed_options);
	...
	options.fields.materials_search = new FieldText("materials_search",filed_options);
		...
		DocMovement_Model.superclass.constructor.call(this,id,options);
}
