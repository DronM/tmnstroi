...
function Material_Model(options){
	...
	options.fields.okei_code = new FieldString("okei_code",filed_options);
	options.fields.okei_code.getValidator().setRequired(true);
	options.fields.okei_code.getValidator().setMaxLength('5');
