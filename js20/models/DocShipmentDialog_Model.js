...
function DocShipmentDialog_Model(options){
	var id = 'DocShipmentDialog_Model';
	options = options || {};
	...
	options.fields.pallets = new FieldJSON("pallets",filed_options);
	
		DocShipmentDialog_Model.superclass.constructor.call(this,id,options);
}
