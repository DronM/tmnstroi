...
function DocMovementList_Model(options){
	var id = 'DocMovementList_Model';
	options = options || {};
	...
	options.fields.to_oktmo_id = new FieldInt("to_oktmo_id",filed_options);
	...
	options.fields.to_oktmo_ref = new FieldJSON("to_oktmo_ref",filed_options);
	...
	options.fields.to_oktmo_contracts_ref = new FieldJSON("to_oktmo_contracts_ref",filed_options);
	...
	options.fields.to_oktmo_contract_id = new FieldInt("to_oktmo_contract_id",filed_options);
	...
	options.fields.materials_search = new FieldText("materials_search",filed_options);
		...
		DocMovementList_Model.superclass.constructor.call(this,id,options);
}
