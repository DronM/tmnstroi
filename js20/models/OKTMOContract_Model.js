...
function OKTMOContract_Model(options){
	var id = 'OKTMOContract_Model';
	options = options || {};
	...
	options.fields.oktmo_id.getValidator().setRequired(true);
	
			
		OKTMOContract_Model.superclass.constructor.call(this,id,options);
}
